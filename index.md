...
## Working Paper
1. Lu, Cheng; Deng, Zhibin; Fang, Shu-Cherng; Xing Wenxun. A branch-and-bound algorithm for max-cut problem by using tree decomposition, working paper, 2021. *Download the test instances used in this paper [here](https://github.com/zhibindeng/Personal/blob/gh-pages/TestSet.zip)*.
